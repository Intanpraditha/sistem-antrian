...
<div class="card">
      <div class="card-header">
        <h1 class="card-title"><b>Tambah Data Pasien</b></h1>
      </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <div class="container">
                    <a href="<?= site_url('pasien') ?>" class="btn btn-secondary">Kembali ke Daftar</a><br></br>
                    <form method="post" action="<?= site_url('pasien/store') ?>">
                        <label class="form-label" >Nama Pasien</label>
                        <input class="form-control" type="text" name="nama_pasien"><br>
                        <label class="form-label" >No. BPJS</label>
                        <input class="form-control" type="number" name="no_bpjs"><br>
                        <label class="form-label" >NIK</label>
                        <input class="form-control" type="number" name="nik"><br>
                        <label class="form-label" >Jenis Kelamin</label> <br>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jk" value="Laki-laki"> Laki-laki <br> 
